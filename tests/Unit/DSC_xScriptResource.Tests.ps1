...
try
{
    InModuleScope $script:dscResourceName {
        Describe 'xScriptResource Unit Tests' {
            BeforeAll {
                ...
                $script:testCredenital = New-Object -TypeName 'System.Management.Automation.PSCredential' -ArgumentList @( $script:testUsername, $script:secureTestPassword )
            }
